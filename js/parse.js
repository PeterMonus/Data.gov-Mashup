...
parser.prototype.csv = function(csvName, callback, filter)
{
  $.get(
      csvName,
      function(data) {dat = parsecsv(data, filter, callback);} ,
      'text'
      );
};
 ...
 * You can pass in any number of pairs,
 * and will only return true if they're all correct
 ***********************/
 ...
 * so we can iterate through easily and get the data we need.
 ************************/
...
//Create a global parse object so we can call parse.csv()
